...
<div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-4">
  <h3 class="text-lg font-semibold mb-2 flex items-center text-gray-800 dark:text-gray-200">
    ...
    <div class="mt-3">
      <div class="mb-2 flex items-center">
        ...
        {#if points.includes(aiSuggestion.suggestedPoint)}
          <span class="ml-2 text-xl font-bold text-green-600 dark:text-lime-400 
            border-green-500 dark:border-lime-400 border px-3 py-1 rounded-lg">{aiSuggestion.suggestedPoint}</span>
        {:else}
          <span class="ml-2 text-xl font-bold text-yellow-600 dark:text-yellow-400
            border-yellow-500 dark:border-yellow-400 border px-3 py-1 rounded-lg">?</span>
        {/if}
      </div>
      <div>
        <span class="font-medium">理由:</span>
        <p class="mt-1 text-gray-700 dark:text-gray-300 p-2 bg-gray-100 dark:bg-gray-700 rounded">
